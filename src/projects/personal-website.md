...
description: "My personal website built 100% by Claude Code from an iPhone 15 Pro. I used the Claude iOS app, connected to the Github iOS app, connected to Vercel for hosting. Written in React, serving as a project portfolio and blog platform."
